        ...
        <div class="layui-form">
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="classname" name="classname"  class="layui-input" value="<?php echo $class['classname'] ?>">
              </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-block">           
                <input type="checkbox" id="checkbox0" lay-skin="primary" title="启用" <?php if($class['isok']==1){ echo "checked=''"; } ?> >
                <input type="checkbox" id="checkbox1" lay-skin="primary" title="停用" <?php if($class['isok']==0){ echo "checked=''"; } ?> >
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <button  class="layui-btn" onclick="upClass(<?php echo $class['id'] ?>)" >
                  确定修改
              </button>
          </div>
      </div>
      ...
      function upClass(id){
        ...
        if($('#checkbox0').is(':checked')&&$('#checkbox1').is(':checked')) {
          ...
          return false;
              ...
              $.post("index.php?r=product/exeupclass/id/"+id,{'classname':classname,'isok':isok},function(data){
                  if (data==1) {
